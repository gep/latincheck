...
class ProcessDomainFormView(BaseFormView):
    ...
    def form_valid(self, form):
        ...
        occurances = html_verificator.search(contents_getter.get_contents(form.clean().get('url')))

        return JsonResponse(occurances)
